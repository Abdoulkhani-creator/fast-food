...
<form action="modifier_employe.php" method="POST">
    ...
    <input type="text" name="employe_num" maxlength="20" required placeholder="Numero de l'employé" class="box">
    ...
    <input type="text" name="specialite" maxlength="20" required placeholder="Specialité" class="box">
    <input type="submit" value="Modifier maintenant" name="modifier_employe" class="btn">
</form>

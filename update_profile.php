...
<!-- Section de mise à jour du profil du directeur -->
<section class="add-products">
   <form action="update_profile1.php" method="POST">
      <h3>Modifier le Profil</h3>
      <label>ID du Directeur:</label>
      <input type="text" name="id_directeur" placeholder="ID du Directeur" class="box" required>
      <label>Nouveau Nom:</label>
      <input type="text" name="new_nom" maxlength="20" placeholder="Nouveau Nom" class="box" required>
      <label>Nouveau Mot de Passe:</label>
      <input type="password" name="new_pass" maxlength="20" placeholder="Nouveau Mot de Passe" class="box" required>

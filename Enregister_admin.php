...
<section class="form-container">
   <form action="Enregister_admin1.php" method="POST">
      ...
      <input type="number" name="num" maxlength="20" required placeholder="Entrez votre num identité" class="box">
      <input type="text" name="name" maxlength="20" required placeholder="Entrez votre nom d'utilisateur" class="box">
      <input type="password" name="pass" maxlength="20" required placeholder="Entrez votre mot de passe" class="box">
      <input type="password" name="cpass" maxlength="20" required placeholder="Confirmez votre mot de passe" class="box">
